...
INSERT INTO `exercicio` VALUES (1,'Supino inclinado c/ barra','Supino inclinado: serve para trabalhar a porção superior do peitoral, Deitado no banco reto, segure a barra (ou os halteres) com a palma das mãos voltadas para a frente.','2021-05-03 13:40:49','',0),(2,'Crusifixo reto','O crucifixo são uma boa opção para quem busca hipertrofia ou uma maior definiÃ§Ã£o do peito. Isso porque os movimentos de aduÃ§Ã£o e abduÃ§Ã£o dos ombros .','2021-05-03 13:43:44','',0),(3,'Supino reto c/ barra ','Sente-se em um banco reto e posicione os halteres em cima dos joelhos,\nAo deitar no banco, use o impulso para trazer ambos os halteres para a posiÃ§Ã£o inicial, alinhados em frente a porÃ§Ã£o superior do peitoral com os braÃ§os esticados.','2021-05-03 13:47:18','',0),(4,'Voador',' Este exercÃ­cio consiste em uma mÃ¡quina especial com suporte para segurar as mÃ£os dos dois lados, de modo que  no movimento de abre e fecha repetidas vezes, ajustando o peso de acordo com a forÃ§a que o usuÃ¡rio irÃ¡ fazer.','2021-05-03 13:50:18','',0),(5,'FrancÃªs deitado c/ halteres ',' O trÃ­ceps francÃªs Ã© um movimento uniarticular, com participaÃ§Ã£o estÃ¡tica dos mÃºsculos do ombro e do tronco, deitado no banco reto, e com os halteres nas  mÃ£os, acima da cabeÃ§a subir  e desce.\n\n','2021-05-03 14:00:15','',0),(6,'Corda cross',' Ã‰ um exercÃ­cio de musculaÃ§Ã£o que trabalha o isolamento da parte de trÃ¡s do braÃ§o, por meio da extensÃ£o do cotovelo, e atua em trÃªs partes do trÃ­ceps ou trÃ­ceps braquial, com a cabeÃ§a medial, longa e, principalmente, a lateral.','2021-05-03 14:18:53','',0),(7,'Barra cross','A barra fixa em parede tem como finalidade a execuÃ§Ã£o de exercÃ­cios fÃ­sicos utilizando o peso do prÃ³prio praticante,sÃ£o responsÃ¡veis pelo aumento de forÃ§a e ganho de massa muscular nas costas, braÃ§os e abdÃ´men.','2021-05-03 14:28:23','',0),(8,'TrÃ­ceps testa ','Segure a barra com os cotovelos estendidos e as mÃ£os na mesma linha dos ombros; Â· Flexione os braÃ§os em 90 graus, sem abri-los, na altura da testa, NÃ£o altere a posiÃ§Ã£o inicial dos braÃ§os e dos ombros durante o movimento.','2021-05-03 14:33:54','',0),(9,'Levantamento terra ','O levantamento terra Ã© um exercÃ­cio de treinamento com pesos que desenvolve os mÃºsculos da regiÃ£o lombar, pernas, trapÃ©zio e glÃºteos. Ã‰ um dos exercÃ­cios mais completos para as costas.','2021-05-03 14:38:06','',0),(10,'Pulley frontal','Ã‰ um exercÃ­cio para costas muito parecido com a barra-fixa, mas com caracterÃ­sticas Ãºnicas que poderÃ£o ser usadas a seu favor para obter mais hipertrofia. Barra fixa, sem dÃºvidas, Ã© a puxada vertical mais eficiente para treinar costas.','2021-05-03 14:51:52','',0),(11,'Pulley atrÃ¡s ','Ã‰ um dos melhores exercÃ­cios para treinar o dorsal,pois Ã© um exercÃ­cio que treina toda a regiÃ£o das costas com eficiÃªncia.','2021-05-03 14:56:36','',0),(12,'Remada baixa ','Ã‰ um dos melhores exercÃ­cios de academia para trabalhar costas. Envolvendo diversos mÃºsculos, mas principalmente o latÃ­ssimo do dorso e o trapÃ©zio, nas porÃ§Ãµes inferior e superior, Ã© um treino realizado sentado em um banco de equipamento ou chÃ£o.','2021-05-03 15:16:21','',0),(13,'Serrote ','Ã‰  extremamente Ãºtil para trabalhar todos os mÃºsculos das costas, Ã© uma opÃ§Ã£o bastante eficaz para quem quer deixar a regiÃ£o mais forte.','2021-05-03 15:32:52','',0),(14,'Rosca alternada c/ banco inclinado ','ExercÃ­cio com a coluna em um Ã¢ngulo inclinado, nosso ombro fica em uma posiÃ§Ã£o onde a cabeÃ§a longa do bÃ­ceps pode ser mais ativada,Pesos Livres, para malhar Biceps. ','2021-05-03 15:42:56','',0),(15,'Rosca SDTT barra W','Usando o banco scott, se posicione de uma maneira que as axilas encaixem no topo do apoio dos braÃ§os,Segure a barra com as duas mÃ£os usando uma pegada supinada (palmas apontadas para o teto.','2021-05-03 15:47:13','',0),(16,'Rosca direta barra reta ','Em pÃ©, mantenha os pÃ©s afastados na largura do quadril e os joelhos levemente flexionados, criando uma base que proporcione bastante estabilidade e equilÃ­brio\nSegure os halteres (ou a barra) com os braÃ§os estendidos ao lado do tronco.','2021-05-03 15:51:23','',0),(17,'Martelo em pÃ© ','Ã‰ um exercÃ­cio para os bÃ­ceps braquiais, com enfoque maior no braquial e no braquiorradial. Com os antebraÃ§os em posiÃ§Ã£o neutra, promove a flexÃ£o do cÃºbito, e, devido ao posicionamento dos antebraÃ§os, atinge o braquiorradial e o braquial.\n\n','2021-05-03 15:56:50','',0),(18,'Rosca punho ',' Ã‰ um exercÃ­cio de treinamento com pesos para o desenvolvimento apenas dos mÃºsculos flexores do punho do antebraÃ§o.','2021-05-03 16:00:21','',0),(19,'Leg press 45','O Leg Press recruta principalmente trÃªs mÃºsculos da parte inferior do corpo: quadrÃ­ceps, glÃºteos e posteriores, independente da sua posiÃ§Ã£o (45o ou 90o, vertical ou horizontal). ','2021-05-03 16:03:43','',0),(20,'Extensor de pernas ','Pode ser feito com as duas pernas juntas ou unilateralmente, ou seja, com uma de cada vez , opÃ§Ã£o interessante para quem apresenta assimetria entre os membros. \"Nesse caso, comece o exercÃ­cio com a perna mais fraca.','2021-05-03 16:08:18','',0),(21,'Flexora sentada','Ã‰ um equipamento que trabalha os trÃªs principais mÃºsculos posteriores: o bÃ­ceps femoral, os semitendÃ­neo e semimembranoso.','2021-05-03 18:09:38','',0),(22,'Adutora e Abdutora ','Os mÃºsculos trabalhados em cada exercÃ­cio sÃ£o os internos da coxa para o adutor, glÃºteos e parte mÃ©dia da coxa para o abdutor.','2021-05-03 19:10:26','',0),(23,'ExercÃ­cio Stiff','Ã‰ Uma variaÃ§Ã£o do tradicional levantamento terra, o stiff Ã© um exercÃ­cio multiarticular que trabalha principalmente os mÃºsculos da parte de trÃ¡s da coxa (isquiotibiais) e dos glÃºteos.','2021-05-03 19:14:03','',0),(24,'Desenvolvimento nuca c/ barra ','Ã‰ um dos melhores exercÃ­cios para ombros, e costumava ser a base do treino de muitos fisiculturistas desde os anos 50 aos 80,Ã‰ o movimento mais efetivo para desenvolvimento geral dos ombros.','2021-05-03 19:19:44','',0),(25,'Desenvolvimento maquina ','Como fazer: ajuste o banco com a pegada na altura do pescoÃ§o. ... Trabalha: peito e braÃ§os (peitoral, trÃ­ceps braquial, deltÃ³ide anterior).','2021-05-03 19:24:44','',0),(26,'ElevaÃ§Ã£o frontal c/ halteres em pÃ© ','Contribui para melhorar a postura Segundo Puggina, a musculatura do core Ã© acionada durante a execuÃ§Ã£o do exercÃ­cio de elevaÃ§Ã£o frontal para estabilizar o corpo, contribuindo para a manutenÃ§Ã£o da postura ereta.','2021-05-03 19:30:50','',0),(27,'ElevaÃ§Ã£o lateral c/ halteres sentado ','Com apenas dois halteres, Ã© possÃ­vel trabalhar a musculatura dos deltoides de forma multifuncional, eficiente e isolada.','2021-05-03 19:35:27','',0),(28,'Ecolhimento c/ halteres ','Sem flexionar os cotovelos (mantenha os braÃ§os retos), encolha os ombros movendo-os em direÃ§Ã£o das orelhas o mÃ¡ximo que vocÃª conseguir.','2021-05-03 19:39:23','',0),(29,'Ecolhimento c/ barra ',' Para executÃ¡-lo, a pessoa permanece ereta, segurando pesos e elevando os ombros o mais alto possÃ­vel, e posteriormente abaixando os ombros, sem dobrar os cotovelos.','2021-05-03 19:43:05','',0),(30,'1','1','2021-05-04 20:19:15','',0);
...
-- Dump completed on 2021-05-04 21:25:19
